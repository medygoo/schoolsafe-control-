...
import { serializeInstance, serializeInstances } from "../http/instance-serializer.js";
...
return { data: serializeInstances(instances) };
});
...
return { data: serializeInstance(updated) };
} catch (err: any) {
